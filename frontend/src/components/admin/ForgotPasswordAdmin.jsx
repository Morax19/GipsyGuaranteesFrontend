...
const ForgotPasswordAdmin = () => {
  ...
  useEffect(() => {
    document.body.classList.add('barraCurvaFPasswordAdmin');

    return () => {
      document.body.classList.remove('barraCurvaFPasswordAdmin');
    };
  }, []);
  ...
  return (
    <div className="cardContainerFPasswordAdmin">
      <div className="back-link-container">
        <Link to="/admin/login">
          <img src={backIcon} alt="Volver" className="back-icon" />
        </Link>
      </div>
      <img src={logo} alt="Logo" className="logoFPasswordAdmin" />
